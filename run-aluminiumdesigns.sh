...
export LEADS_MIRROR_PATH="${LEADS_MIRROR_PATH:-/var/backups/aluminiumdesigns/live}"
...
mkdir -p "$MONITORING_EVENTS_PATH" "$LEADS_DATA_PATH" "$LEADS_MIRROR_PATH"
chmod 700 "$MONITORING_EVENTS_PATH" "$LEADS_DATA_PATH" "$LEADS_MIRROR_PATH"
