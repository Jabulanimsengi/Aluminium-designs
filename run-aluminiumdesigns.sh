#!/usr/bin/env bash
RELEASE_DIR="/var/www/aluminiumdesigns-release-b97bb15"
set -a
. "$RELEASE_DIR/.env"
set +a
...
elif [ -f "$RELEASE_DIR/.next/standalone/aluminiumdesigns-release-b97bb15/server.js" ]; then
  SERVER_JS="$RELEASE_DIR/.next/standalone/aluminiumdesigns-release-b97bb15/server.js"
  SERVER_DIR="$RELEASE_DIR/.next/standalone/aluminiumdesigns-release-b97bb15"
else
