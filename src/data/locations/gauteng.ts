...
export const gautengLocations: SALocationObject[] = [
  // ==========================================
  // GAUTENG PROVINCE & REGIONAL HUBS
  // ==========================================
  {
    id: "loc-gp-gauteng",
    slug: "gauteng",
    ...
    province: "Gauteng",
    provinceAbbr: "GP",
    metroOrDistrict: "Gauteng Province",
    postalCodes: ["2000", "0001", "1600", "1400", "1900"],
    suburbsOrAreas: [
      "Johannesburg", "Pretoria", "Centurion", "East Rand", "West Rand", "Sandton",
      "Midrand", "Randburg", "Roodepoort", "Kempton Park", "Boksburg", "Alberton", "Vaal Triangle"
    ],
    coordinates: { latitude: -26.2041, longitude: 28.0473 },
    climateZone: "Highveld Inland",
    dialingCode: "011",
    seoDescription: "Gauteng province wide custom aluminium and steel manufacturing, installations, and factory direct services."
  },
  {
    id: "loc-gp-east-rand",
    slug: "east-rand",
    ...
    province: "Gauteng",
    provinceAbbr: "GP",
    metroOrDistrict: "City of Ekurhuleni (East Rand)",
    postalCodes: ["1401", "1459", "1501", "1619", "1449"],
    suburbsOrAreas: [
      "Germiston", "Boksburg", "Benoni", "Kempton Park", "Bedfordview", "Edenvale",
      "Alberton", "Brakpan", "Springs", "Nigel", "Tembisa", "Isando", "Jet Park", "Spartan", "Katlehong"
    ],
    coordinates: { latitude: -26.2125, longitude: 28.2611 },
    climateZone: "Highveld Inland",
    dialingCode: "011",
    seoDescription: "East Rand Ekurhuleni regional manufacturing, residential installations, and commercial services."
  },
  {
    id: "loc-gp-west-rand",
    slug: "west-rand",
    ...
    province: "Gauteng",
    provinceAbbr: "GP",
    metroOrDistrict: "West Rand District",
    postalCodes: ["1739", "1724", "1759", "1779", "2499"],
    suburbsOrAreas: [
      "Krugersdorp", "Roodepoort", "Randfontein", "Westonaria", "Carletonville",
      "Noordheuwel", "Featherbrooke Estate", "Muldersdrift", "Kagiso", "Constantia Kloof", "Florida"
    ],
    coordinates: { latitude: -26.0858, longitude: 27.7753 },
    climateZone: "Highveld Inland",
    dialingCode: "011",
    seoDescription: "West Rand regional custom aluminium windows, doors, security bars, and installations."
  },
  {
    id: "loc-gp-vaal",
    slug: "vaal",
    ...
    province: "Gauteng",
    provinceAbbr: "GP",
    metroOrDistrict: "Sedibeng District (Vaal)",
    postalCodes: ["1911", "1939", "1961", "1441"],
    suburbsOrAreas: [
      "Vanderbijlpark", "Vereeniging", "Meyerton", "Heidelberg", "Three Rivers",
      "Henley on Klip", "Sebokeng", "Flora Gardens", "Riversdale"
    ],
    coordinates: { latitude: -26.7117, longitude: 27.8378 },
    climateZone: "Highveld Inland",
    dialingCode: "016",
    seoDescription: "Vaal Triangle and Sedibeng regional aluminium, steel, and security installations."
  },
