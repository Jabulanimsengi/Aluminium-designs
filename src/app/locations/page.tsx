...
export const metadata = {
  ...
  description: "View our comprehensive list of service areas across Gauteng. Apex Aluminium designs, manufactures, and installs premium windows and doors in Johannesburg, Pretoria, and surrounding areas.",
};
    ...
    <div className="bg-surface text-on-surface">
      ...
      <section className="relative py-20 lg:py-32 bg-surface-container-low border-b border-outline-variant">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl border border-outline-variant bg-surface-container text-secondary mb-4">
          ...
          <p className="font-sans text-on-surface-variant text-lg max-w-2xl mx-auto leading-relaxed">
            Apex Aluminium provides premium custom aluminium windows, doors, and installations across the entire Gauteng province. Find your area below.
          </p>
        </div>
      </section>
            ...
            return (
              <div key={municipality} className="space-y-8">
                <div className="flex items-center space-x-4 border-b border-outline-variant pb-4">
                  <h2 className="font-sans font-bold uppercase tracking-tight text-3xl text-primary">
                    {municipality}
                  </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {sortedLocations.map((loc) => (
                    <Link
                      ...
                      className="group flex items-center justify-between p-4 rounded-xl border border-outline-variant hover:border-primary hover:bg-surface-container transition-all"
                    >
                      <div className="flex items-center space-x-3">
                        <MapPin className="w-4 h-4 text-outline group-hover:text-on-tertiary-container transition-colors" />
                        <span className="font-sans font-medium text-on-surface-variant group-hover:text-primary transition-colors">
                          {loc.name}
                        </span>
                      </div>
